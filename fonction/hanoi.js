...
function hanoi(taille,TD,TI,TA){
  if(taille == 1){

    compteur ++;
    
    console.log(""+compteur+" Déplacer de "+ TD + " vers " + TA);
  }else{
    
    hanoi(taille-1,TD,TA,TI);
    compteur ++;
    console.log(""+compteur+" Déplacer de "+ TD + " vers " + TA);
    hanoi(taille-1,TI,TD,TA);
  }
}

hanoi(8,"TD","TI","TA"); // Je demande : comment déplacer 3 disques de la tour "un" vers la tour "trois", avec la tour "deux" en intermédiaire.
/*
